...
def load_cora():
    ...
    idx_features_labels = np.genfromtxt(r"C:\Users\benja\Documents\MVA\P1\Altegrad\TP5\code\data\cora.content", dtype=np.dtype(str))
    ...
    edges_unordered = np.genfromtxt(r"C:\Users\benja\Documents\MVA\P1\Altegrad\TP5\code\data\cora.cites", dtype=np.int32)
